...
<div clas='right'>
	...
	계약기간<input type='date' name='contract_period_s' id='contract_period_s' value='${vo.contract_period_s}'>~
	<input type='date' name='contract_period_e' id='contract_period_e' value='${vo.contract_period_e}'><br/>
...
<table id='post'>
	<tr>
	<td>post</td><td>addr1</td>
	</tr>	
	<c:forEach items='${postList}' var='postList' varStatus="status">
	<tr>
	<td class='postList1' id='postList${status.count}'>${postList.post_num }</td>
	<td class='postList2'>${postList.addr1}</td>
	</tr>
	</c:forEach>
</table>
</div>
...
<button id='addr1_button' onclick='try_cont()'>찾기</button>
<button class='close' >닫기</button>
<table id='post'>
	<tr>
	<td>영문</td><td>한글</td>
	</tr>	
	<c:forEach items='${countryList}' var='countryList' varStatus="status">
	<tr>
	<td class='countryList1' id='countryList${status.count}'>${countryList.country_eng }</td>
	<td class='countryList2'>${countryList.country_kor}</td>
	</tr>
	</c:forEach>
</table>
...
$('#left_list td').dblclick(function() {
 ...
 //우편번호 새 창이 뜰 때
$('#post_select tr').dblclick(function() {
...
//국가명 입력 새 창이 뜰 때
$('#country_select tr').dblclick(function() {
    var Id1 = $(this).children('td:eq(0)').text();
    var Id2 = $(this).children('td:eq(1)').text();
    //var Id2 = $(this+'td:eq(2)').text();
   // var busi_num = left_busi_num.val();
